...
import { ViewAction, ActionOptions } from "@/components/ActionOptions";
...
const columns = [
  ...
  { header: "Last Login", key: "last_login", className: "hidden xl:table-cell" },
